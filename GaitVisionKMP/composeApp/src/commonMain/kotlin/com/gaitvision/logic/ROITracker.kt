...
import com.gaitvision.logic.GaitConfig
...
class ROITracker(
    ...
    private fun computeFarLegConf(confidences: FloatArray): Float {
        return min(
            confidences[PoseIndices.LEFT_ANKLE],
            confidences[PoseIndices.RIGHT_ANKLE]
        )
    }
    ...
    private fun updateRoiBounds(
        ...
        val coreIndices = intArrayOf(
            PoseIndices.LEFT_SHOULDER, PoseIndices.RIGHT_SHOULDER,
            PoseIndices.LEFT_HIP, PoseIndices.RIGHT_HIP,
            PoseIndices.LEFT_KNEE, PoseIndices.RIGHT_KNEE,
            PoseIndices.LEFT_ANKLE, PoseIndices.RIGHT_ANKLE
        )
     ...
     */
    fun getRoiBounds(frameWidth: Int, frameHeight: Int, useExpanded: Boolean = false): RoiRect {
        if (roiCenterX == null || roiSize == null) {
            return RoiRect(0, 0, frameWidth, frameHeight)
        }
